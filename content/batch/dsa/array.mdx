...
<Callout>
  ...
  [@github](https://github.com/FrontendFreaks/Official-Website).
</Callout>
...
{" "}
<Callout type="info">
  We hope that you found the tutorial video helpful in understanding the Array
  Data Dtructure, You can refer this notes 📝 for quick revision.
</Callout>
