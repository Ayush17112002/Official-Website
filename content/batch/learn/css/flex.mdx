...
<Callout type="info">
  We hope that you found the tutorial video helpful in understanding the basic
  concepts of Flexbox, You can refer this notes 📝 for quick revision.
</Callout>
...
<TabsContent value="interview">Interview Questions on CSS Flex</TabsContent>
