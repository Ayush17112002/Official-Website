...
<TabsContent value="interview">Interview Questions on CSS Grid</TabsContent>

</Tabs>

<Callout type="calm">
  Congratulations on completing the CSS, CSS Flexbox, and CSS Grid tutorials!
  Now it's time to level up your skills and learn about Git and Github. These
  tools are essential for version control and collaboration in web development
</Callout>
